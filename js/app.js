...
function agregarPlatillo(producto) {
    ...
    if(producto.cantidad > 0) {
        // Comprueba si un elemento ya existe en el arreglo
        if( pedido.some(articulo => articulo.id === producto.id) ) {
            ...
            // El articulo no existe, lo agregramos
...
function eliminarProducto(id) {
    ...
    // El producto eliminado regresa su cantidad a 0 en el formulario
    const productoSelector = `#producto-${id}`;
    const productoInput = document.querySelector(productoSelector);
...
function formularioPropinas() {
    ...
    radioMasDiv.appendChild(radioMas)
    radioMasDiv.appendChild(radioMasLabel)
    ...
    divFormulario.appendChild(radioMasDiv)
